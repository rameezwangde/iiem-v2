              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <div className="aspect-[4/3] bg-brand-purple/10 overflow-hidden border border-brand-textDark/10">
                    <img src="https://images.unsplash.com/photo-1542744173-8e7e53415bb0?auto=format&fit=crop&w=600&q=80" alt="Pitch Deck" className="w-full h-full object-cover filter grayscale opacity-70 group-hover:opacity-100 transition-opacity" />
                  </div>
                </div>
                <div>
                  <div className="text-[10px] font-bold text-brand-teal tracking-widest uppercase mb-2">The Execution</div>
                  <div className="aspect-[4/3] bg-brand-purple/10 overflow-hidden border border-brand-textDark/10">
                    <img src="https://images.unsplash.com/photo-1540039155732-68b0e8b15d97?auto=format&fit=crop&w=600&q=80" alt="Live Event" className="w-full h-full object-cover filter grayscale group-hover:grayscale-0 transition-all duration-500" />
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="border border-brand-textDark/15 bg-brand-cream p-6 group hover:-translate-y-1 transition-transform neo-shadow-teal">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <div className="aspect-[4/3] bg-brand-purple/10 overflow-hidden border border-brand-textDark/10">
                    <img src="https://images.unsplash.com/photo-1515378960530-7c0da6231fb1?auto=format&fit=crop&w=600&q=80" alt="Planning" className="w-full h-full object-cover filter grayscale opacity-70 group-hover:opacity-100 transition-opacity" />
                  </div>
                </div>
                <div>
                  <div className="text-[10px] font-bold text-brand-teal tracking-widest uppercase mb-2">The Execution</div>
                  <div className="aspect-[4/3] bg-brand-purple/10 overflow-hidden border border-brand-textDark/10">
                    <img src="https://images.unsplash.com/photo-1519225421980-715cb0215aed?auto=format&fit=crop&w=600&q=80" alt="Wedding Setup" className="w-full h-full object-cover filter grayscale group-hover:grayscale-0 transition-all duration-500" />
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            {[
              ...
              <div key={idx} className="relative group overflow-hidden border border-brand-cream/15 aspect-square">
                <img src={item.img} alt={item.label} className="w-full h-full object-cover filter grayscale group-hover:grayscale-0 transition-all duration-700 hover:scale-110" />
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="border border-brand-textDark/15 overflow-hidden group">
              <div className="aspect-video bg-brand-purple/10 overflow-hidden relative">
                <img src="https://images.unsplash.com/photo-1533174072545-7a4b6ad7a6c3?auto=format&fit=crop&w=800&q=80" alt="Concert" className="w-full h-full object-cover filter grayscale group-hover:grayscale-0 transition-all duration-700 hover:scale-105" />
            ...
            <div className="border border-brand-textDark/15 overflow-hidden group">
              <div className="aspect-video bg-brand-purple/10 overflow-hidden relative">
                <img src="https://images.unsplash.com/photo-1511795409834-ef04bbd61622?auto=format&fit=crop&w=800&q=80" alt="Corporate Event" className="w-full h-full object-cover filter grayscale group-hover:grayscale-0 transition-all duration-700 hover:scale-105" />
                <div className="absolute top-4 left-4 bg-white text-brand-dark px-3 py-1 font-display text-sm flex items-center gap-2 neo-shadow">
